...
const slides: Slide[] = [
    {
        ...
        description: "Order from our simple menu of physical exams, lab tests, drug tests and vaccines.",
        image: slide1,
    },
    {
        title: "OccuHealth",
        subtitle: "Data Warehouse",
        description: "Order from our vast inventory of health data, including physical exams, lab tests, drug tests, and vaccination history.",
        image: slide2,
    },
    {
        title: "OccuHealth",
        ...
        <div className="relative w-full min-h-[90vh] overflow-hidden">
            ...
            {slides.map((slide, index) => (
                <div
                    ...
                    style={{ backgroundImage: `url(${slide.image})`, backgroundSize: "cover", backgroundPosition: "top" }}
                >
                    <div className="absolute md:top-1/2 md:left-30 top-1/4 left-10 max-w-lg text-white p-6 transform -translate-y-1/2" style={{background:'#338a47dc'}}>
            ...
            <div className="absolute right-5 top-1/2 -translate-y-1/2 flex flex-col gap-3">
                {slides.map((_, index) => (
                    <button
                        ...
                        className={`w-3 h-3 rounded-full border ${index === current ? "bg-yellow-400 border-yellow-400" : "bg-gray-300 border-gray-400"
                            }`}
                    />
                ))}
            </div>
