      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-y-8 lg:gap-x-8 items-start">
        ...
        <div className="flex flex-col items-center text-center lg:border-r lg:border-gray-300">
          <div className="w-24 h-24 flex items-center justify-center mb-4">
            <img src="/src/assets/Ph1.svg" alt="Become a Client icon" className="w-full h-full object-contain" />
          </div>
        ...
        <div className="flex flex-col items-center text-center lg:border-r lg:border-gray-300">
          <div className="w-24 h-24 flex items-center justify-center mb-4">
            <img src="/src/assets/Ph2.svg" alt="Create Employee Profile icon" className="w-full h-full object-contain" />
          </div>
        ...
        <div className="flex flex-col items-center text-center lg:border-r lg:border-gray-300">
          <div className="w-24 h-24 flex items-center justify-center mb-4">
            <img src="/src/assets/Ph3.svg" alt="Submit Order icon" className="w-full h-full object-contain" />
          </div>
        ...
        <div className="flex flex-col items-center text-center lg:border-r lg:border-gray-300">
          <div className="w-24 h-24 flex items-center justify-center mb-4">
            <img src="/src/assets/Ph4.svg" alt="Employee Schedules Appointment icon" className="w-full h-full object-contain" />
          </div>
        ...
        <div className="flex flex-col items-center text-center lg:border-r lg:border-gray-300">
          <div className="w-24 h-24 flex items-center justify-center mb-4">
            <img src="/src/assets/Ph5.svg" alt="Employee Receives Health Screening icon" className="w-full h-full object-contain" />
          </div>
        ...
        <div className="flex flex-col items-center text-center">
          <div className="w-24 h-24 flex items-center justify-center mb-4">
            <img src="/src/assets/Ph6.svg" alt="Results Delivered in Employer Portal icon" className="w-full h-full object-contain" />
          </div>
